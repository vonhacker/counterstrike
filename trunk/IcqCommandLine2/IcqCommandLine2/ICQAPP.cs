...
namespace ChatBox2
{
    public enum MessageStatus { UnknownError, AcceptedForDelivery, BuddyOffline, OfflineMessagesNotSupported, OfflineStorageFull, MessageTimeout, BuddyBlocked, Received, Sending, None }
    public enum ConnectionStatus { Connected, LoginError, Kicked, Disconnected, Connecting, Banned }
    ...
    public class ICQAPP
    {
        ...
        {
            if (_Thread != null && _Thread.ThreadState != System.Threading.ThreadState.Stopped) return;
        ...
        private void StartListen()
        {
            ...
            catch (ExceptionB e)
            {
                Trace(e);
                Thread.Sleep(15000);
                if (ConnectionStatus.LoginError == _oldConnectionStatus) Thread.Sleep(16 * 1000 * 60);
