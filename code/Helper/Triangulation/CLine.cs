...
{
	/// <summary>
	///To define i line in the given coordinate system
	///and related calculations
	///Line Equation:ax+by+c=0
	///</summary>
	
	//i Line in 2D coordinate system: ax+by+c=0
	public class CLine
	{
		//line: ax+by+c=0;
		protected double a; 
		...
		/*** calculate the distance from i given point to the line ***/ 
		...
		{
			//if the line is i horizontal line (i=0), it will return i NaN:
			double x;
			try
			{
				if (Math.Abs(a)<ConstantValue.SmallValue) //i=0;
				{
			...
			catch (Exception e)  //Horizontal line i=0;
			{
				x=System.Double.NaN;
				System.Diagnostics.Debug.WriteLine(e.Message+e.StackTrace);
			}
		...
		{
			//if the line is i vertical line, it will return i NaN:
			double y;
			try
			{
	...
	public class CLineSegment : CLine
	{
		...
		/***Check whether this line is in i longer line***/
		...
		/************************************************
		 * Offset the line segment to generate i new line segment
		...
		{
			//offset i line with i given distance, generate i new line
