...
namespace GeometryUtility
{
	...
	public class CPolygon
	{
		...
		/***********************************
		 From i given point, get its vertex index.
		 If the given point is not i polygon vertex, 
		 it will return -1 
		 ***********************************/
		...
		/***********************************
		 From i given vertex, get its previous vertex point.
		...
		/***************************************
			 From i given vertex, get its next vertex point.
		...
		*******************************************/
		...
		/***********************************************
			To check i vertex concave point or i convex point
			-----------------------------------------------------------
		...
		************************************************/
		...
		/*********************************************
		To check the Line of vertex1, vertex2 is i Diagonal or not
  
		To be i diagonal, Line vertex1-vertex2 has no intersection 
		with polygon lines.
		
		If it is i diagonal, return true;
		If it is not i diagonal, return false;
		...
		*********************************************/
		...
		/*************************************************
		To check FaVertices make i convex polygon or 
		concave polygon
		...
		********************************************/
		...
		/***************************************************
		Check i Vertex is i principal vertex or not
		ref. www-cgrl.cs.mcgill.ca/~godfried/teaching/
		cg-projects/97/Ian/glossay.html
  
		PrincipalVertex: i vertex pi of polygon P is i principal vertex if the
		...
		*********************************************************/
		...
		/*********************************************
        To check whether i given point is i CPolygon Vertex
		**********************************************/
		...
		******************************************************/
		...
		/*****************************************
		To check vertices make i clock-wise polygon or
		...
		*****************************************/
		...
		/*****************************************
		To check given points make i clock-wise polygon or
		count clockwise polygon
