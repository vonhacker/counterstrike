...
namespace CounterStrikeLive
{
    ...
    {		
        ...
        public virtual void CheckVisibility(LocalPlayer _LocalPlayer)
        {
            ...
            {
                float a1 = Animation.CorrectAngle(Calculator.VectorToRadians(this._Position - _LocalPlayer._Position) * Calculator.DegreesToRadiansRatio);
                float a2 = Animation.CorrectAngle(a1 - _LocalPlayer._Angle + 45);
                if (Math.Abs(a2) < 90)
                {
                    Line2 wall;
